...
export type StrapiGqlBlogEntryFragmentFragment = {
  ...
  StrapiGqlBlogEntry,
  "id" | "created_at" | "updated_at" | "title" | "slug" | "published_at"
> & {
    content?: Maybe<
      Array<
        Maybe<
...
export type StrapiGqlBlogBySlugQuery = { __typename?: "Query" } & {
  blogEntries?: Maybe<
    Array<
      Maybe<
        { __typename?: "BlogEntry" } & Pick<
          StrapiGqlBlogEntry,
          "id" | "created_at" | "title" | "slug" | "published_at"
        > & {
            blog_category?: Maybe<
...
export type StrapiGqlBlogEntriesQueryVariables = Exact<{
  [key: string]: never;
}>;

export type StrapiGqlBlogEntriesQuery = { __typename?: "Query" } & {
  blogEntries?: Maybe<
    Array<
...
export type StrapiGqlNavigationEntriesQueryVariables = Exact<{
  [key: string]: never;
}>;

export type StrapiGqlNavigationEntriesQuery = { __typename?: "Query" } & {
  menu?: Maybe<
    { __typename?: "Menu" } & {
      entries?: Maybe<
        Array<
...
export type StrapiGqlPageBySlugQuery = { __typename?: "Query" } & {
  pages?: Maybe<
    Array<
      Maybe<
        { __typename?: "Page" } & Pick<
...
export type StrapiGqlPagesQuery = { __typename?: "Query" } & {
  pages?: Maybe<
    Array<
      Maybe<
        { __typename?: "Page" } & Pick<
...
export type StrapiGqlSlideshowByIdQueryVariables = Exact<{
  id: Scalars["ID"];
}>;

export type StrapiGqlSlideshowByIdQuery = { __typename?: "Query" } & {
  sectionSlideshow?: Maybe<
    ...
    > & {
        entries?: Maybe<
          Array<
            Maybe<
              | ({ __typename?: "ComponentSlideshowSlideshowEntryPage" } & Pick<
                  StrapiGqlComponentSlideshowSlideshowEntryPage,
                  "id" | "subtitle"
                > & {
                    image?: Maybe<
                    ...
                    >;
                    link?: Maybe<
                      { __typename?: "Page" } & Pick<StrapiGqlPage, "slug">
                    >;
                  })
              | ({ __typename?: "ComponentSlideshowSlideshowEntry" } & Pick<
                  StrapiGqlComponentSlideshowSlideshowEntry,
                  "id" | "subtitle"
                > & {
                    image?: Maybe<
              ...
              | ({ __typename?: "ComponentSlideshowSlideshowEntryBlog" } & Pick<
                  StrapiGqlComponentSlideshowSlideshowEntryBlog,
                  "id" | "subtitle"
                > & {
                    image?: Maybe<
