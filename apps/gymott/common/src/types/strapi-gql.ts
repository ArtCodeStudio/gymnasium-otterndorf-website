...
export type StrapiGqlBlogCategoryGroupBy = {
  ...
  display_name?: Maybe<Array<Maybe<StrapiGqlBlogCategoryConnectionDisplay_Name>>>;
...
export type StrapiGqlBlogEntryContentDynamicZone = StrapiGqlComponentContentText | StrapiGqlComponentContentImage;
...
export type StrapiGqlHomeSectionsDynamicZone = StrapiGqlComponentSectionSlideshow | StrapiGqlComponentSectionFacts | StrapiGqlComponentContentText | StrapiGqlComponentContentImage;
...
export type StrapiGqlNavigationLinkTypeDynamicZone = StrapiGqlComponentLinkTypeWeb | StrapiGqlComponentLinkTypeSchulfach | StrapiGqlComponentLinkTypePage | StrapiGqlComponentLinkTypeBlog;
...
export type StrapiGqlHomeSectionsQuery = (
  ...
  & { home?: Maybe<(
    ...
    & { sections?: Maybe<Array<Maybe<(
      ...
      { __typename: 'ComponentContentText' }
      & Pick<StrapiGqlComponentContentText, 'text'>
    ) | (
      { __typename: 'ComponentContentImage' }
      & Pick<StrapiGqlComponentContentImage, 'caption'>
      & { image?: Maybe<(
        { __typename?: 'UploadFile' }
...
export type StrapiGqlPagesQuery = (
  ...
  & { pages?: Maybe<Array<Maybe<(
    { __typename?: 'Page' }
    & Pick<StrapiGqlPage, 'id' | 'created_at' | 'updated_at' | 'title' | 'slug' | 'calendar_key' | 'published_at'>
    & { content?: Maybe<Array<Maybe<{ __typename: 'ComponentContentImage' } | { __typename: 'ComponentContentText' }>>>, assets?: Maybe<Array<Maybe<(
      { __typename?: 'ComponentSidebarAssets' }
      & Pick<StrapiGqlComponentSidebarAssets, 'name'>
      & { file?: Maybe<(
        { __typename?: 'UploadFile' }
...
export type StrapiGqlSlideshowByIdQuery = (
  { __typename?: 'Query' }
  & { sectionSlideshow?: Maybe<(
    ...
    & { entries?: Maybe<Array<Maybe<(
      { __typename?: 'ComponentSlideshowSlideshowEntryPage' }
      & Pick<StrapiGqlComponentSlideshowSlideshowEntryPage, 'id' | 'subtitle'>
      & { image?: Maybe<(
        { __typename?: 'UploadFile' }
        & Pick<StrapiGqlUploadFile, 'formats'>
      )>, link?: Maybe<(
      ...
      { __typename?: 'ComponentSlideshowSlideshowEntryBlog' }
      & Pick<StrapiGqlComponentSlideshowSlideshowEntryBlog, 'id' | 'subtitle'>
      & { image?: Maybe<(
        { __typename?: 'UploadFile' }
        & Pick<StrapiGqlUploadFile, 'formats'>
      )>, link?: Maybe<(
