...
export type StrapiGqlSchoolSubjectDetailFragmentFragment = (
  { __typename: 'Subject' }
  & Pick<StrapiGqlSubject, 'id' | 'slug' | 'title' | 'created_at' | 'updated_at' | 'blackboard_image'>
